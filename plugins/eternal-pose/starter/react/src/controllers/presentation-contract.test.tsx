  ...
  return {
    ...
    mapProfile: {
      ...
      marker: (place, index) => ({
        ...
        fallback: { fill: "#ffffff", stroke: "#000000", labelColor: "#000000", text: String(index + 1), size: 44, shape: "circle", strokeWidth: 3 },
      }),
      userLocation: () => ({
        title: "location",
        ...
        fallback: { fill: "#000000", stroke: "#ffffff", labelColor: "#ffffff", text: "", size: 44, shape: "circle", strokeWidth: 3 },
      }),
